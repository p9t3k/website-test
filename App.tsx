...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-navy-950 font-sans text-slate-900 dark:text-white selection:bg-blue-400 selection:text-white transition-colors duration-300">
